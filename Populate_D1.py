...
def getFilePaths():
    """Retrieves all filepaths from directory and returns a list containing all paths."""
...
def InsertStaticData(db_name, db_user, db_password):
    ...
    # The four data types for dataset 1
    ...
    for i in range(10):  # For the ten experimental units
...
def InsertData(filepath, db_name, db_user, db_password, experimentalunitnumber, endpointnumber,
    ...
    unit ID, endpoint ID and datatype ID to be used when filling
    the database with the correct inputs.
