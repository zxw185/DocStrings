...
def getTreatment(treatmentID):
    """Finds and returns the metadata of a treatment."""
...
def QueryAllUnits(datatypeID, treatmentID):
    """Queries the vault to return all data points for all units, given a treatmentID"""
...
def QueryUnit(experimentalunitID, datatypeID, treatmentID):
    """Queries the vault to return all data for a a given experimental unit."""
...
def TimeSeries(data):
    """Returns the correct variables dependent upon the number of columns in the data."""
...
def TimeSeriesAverage(data):
    """Returns the variables for the average data plots."""
